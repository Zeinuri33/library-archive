    ...
    const submit = (e: React.FormEvent) => {
        ...
        post('/klasifikasi', {
            onSuccess: () => {
                setOpen(false)
                reset()
                toast('Klasifikasi surat berhasil ditambahkan')
            },
            ...
            <DialogContent>
                <DialogHeader>
                    <Heading
                        ...
                        description="Kode klasifikasi arsip untuk nomor surat & arsip."
                    />
                    <Separator />
                </DialogHeader>
