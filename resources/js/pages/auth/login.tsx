...
export default function Login({
    ...
    const themeStyles = {
        blue: {
            ...
            ring: 'focus:ring-blue-500/20 dark:focus:ring-blue-500/30',

            grid:
                'bg-[linear-gradient(to_right,rgba(59,130,246,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(59,130,246,0.08)_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,rgba(59,130,246,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(59,130,246,0.06)_1px,transparent_1px)]',

            glowTop: 'bg-blue-500/20 dark:bg-blue-500/10',
            glowBottom: 'bg-blue-400/10 dark:bg-blue-400/10',
            ...
            checkbox:
                'border-blue-500/30 data-[state=checked]:bg-blue-600',
